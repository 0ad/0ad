...

{
	...
	const pForestD = [
		tForestFloor + TERRAIN_SEPARATOR + oTree,
		tForestFloor
	];
	const pForestP1 = [
		tForestFloor + TERRAIN_SEPARATOR + oPalm1,
		tForestFloor
	];
	const pForestP2 = [
	...
	globalThis.g_Map = new RandomMap(heightSeaGround, tGrass);
	...
	createArea(
		new HeightPlacer(Elevation_IncludeMin_ExcludeMax, heightWaterLevel, heightShore),
