...

{
	...
	globalThis.g_Map = new RandomMap(heightShore, tHill);
	...
	paintTerrainBasedOnHeight(heightSeaGround, heightCorralsLower, Elevation_ExcludeMin_IncludeMax,
		tCoralsLower);
	paintTerrainBasedOnHeight(heightCorralsLower, heightCorralsUpper, Elevation_ExcludeMin_IncludeMax,
		tCoralsUpper);
