...
GameState.prototype.getEnemySoldiers = function(){
	var filter = Filters.byClassesOr(["CitizenSoldier", "Super", "Siege"]);
	return this.updatingCollection("enemy-soldiers", filter, this.getEnemyEntities());
};

GameState.prototype.getOwnSoldiers = function(){
	var filter = Filters.byClassesOr(["CitizenSoldier", "Super", "Siege"]);
	return this.updatingCollection("own-soldiers", filter, this.getOwnEntities());
};
