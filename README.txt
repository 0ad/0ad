...
以下為聯繫我們的管道：
  ...
  Web site（網站）: http://play0ad.com/

  Forums（論壇）: http://www.wildfiregames.com/forum/

  Trac (development info, bug tracker)（開發資訊,bug回報網站）: http://trac.wildfiregames.com/

  IRC(線上交流）: #0ad on irc.quakenet.org
...
開啟 "binaries\system" 檔案夾
運行遊戲：Run pyrogenesis.exe
運行地圖編輯器：Run Atlas.bat or "pyrogenesis.exe -editor"
