...
namespace FUXmlParser
{
	...
	FCOLLADA_EXPORT const fm::string& XmlToString(const char* s);
	...
	FCOLLADA_EXPORT const fm::string& ReadNodeProperty(xmlNode* node, const char* property);
	...
	FCOLLADA_EXPORT const fm::string& ReadNodeContentFull(xmlNode* node);
};
