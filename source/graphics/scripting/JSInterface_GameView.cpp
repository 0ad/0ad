...
bool JSI_GameView::Get##NAME##Enabled(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate)) \
{ \
...
\
void JSI_GameView::Set##NAME##Enabled(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), bool Enabled) \
{ \
	if (!g_Game || !g_Game->GetView()) \
	{ \
...
JS::Value JSI_GameView::GetCameraPivot(ScriptInterface::RealmPrivate* pRealmPrivate)
{
 ...
 */
void JSI_GameView::CameraMoveTo(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), entity_pos_t x, entity_pos_t z)
{
 ...
 */
void JSI_GameView::SetCameraTarget(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), float x, float y, float z)
{
 ...
 */
void JSI_GameView::SetCameraData(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), entity_pos_t x, entity_pos_t y, entity_pos_t z, entity_pos_t rotx, entity_pos_t roty, entity_pos_t zoom)
{
	if (!g_Game || !g_Game->GetWorld() || !g_Game->GetView() || !g_Game->GetWorld()->GetTerrain())
		return;
 ...
 */
void JSI_GameView::CameraFollow(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), entity_id_t entityid)
{
	if (!g_Game || !g_Game->GetView())
		return;
 ...
 * @param entityid unit id to follow. If zero, stop following mode.
 */
void JSI_GameView::CameraFollowFPS(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), entity_id_t entityid)
{
	if (!g_Game || !g_Game->GetView())
		return;
...
entity_id_t JSI_GameView::GetFollowedEntity(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	if (!g_Game || !g_Game->GetView())
...
CFixedVector3D JSI_GameView::GetTerrainAtScreenPoint(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), int x, int y)
{
