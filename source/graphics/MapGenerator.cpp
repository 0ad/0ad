...
double CMapGeneratorWorker::GetMicroseconds(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return JS_Now();
}
...
bool CMapGeneratorWorker::LoadLibrary(ScriptInterface::RealmPrivate* pRealmPrivate, const VfsPath& name)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
	return self->LoadScripts(name);
}

void CMapGeneratorWorker::ExportMap(ScriptInterface::RealmPrivate* pRealmPrivate, JS::HandleValue data)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
...
void CMapGeneratorWorker::SetProgress(ScriptInterface::RealmPrivate* pRealmPrivate, int progress)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
...
CParamNode CMapGeneratorWorker::GetTemplate(ScriptInterface::RealmPrivate* pRealmPrivate, const std::string& templateName)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
...
bool CMapGeneratorWorker::TemplateExists(ScriptInterface::RealmPrivate* pRealmPrivate, const std::string& templateName)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
	return self->m_TemplateLoader.TemplateExists(templateName);
}

std::vector<std::string> CMapGeneratorWorker::FindTemplates(ScriptInterface::RealmPrivate* pRealmPrivate, const std::string& path, bool includeSubdirectories)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
	return self->m_TemplateLoader.FindTemplates(path, includeSubdirectories, SIMULATION_TEMPLATES);
}

std::vector<std::string> CMapGeneratorWorker::FindActorTemplates(ScriptInterface::RealmPrivate* pRealmPrivate, const std::string& path, bool includeSubdirectories)
{
	CMapGeneratorWorker* self = static_cast<CMapGeneratorWorker*>(pRealmPrivate->pCBData);
...
JS::Value CMapGeneratorWorker::LoadHeightmap(ScriptInterface::RealmPrivate* pRealmPrivate, const VfsPath& filename)
{
