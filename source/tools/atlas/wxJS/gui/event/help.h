...
namespace wxjs
{
    namespace gui
    {
        ...
        public:
            ...
            static bool GetProperty(PrivHelpEvent *p, JSContext *cx, JSObject *obj, int id, jsval *vp);
            static bool SetProperty(PrivHelpEvent *p, JSContext *cx, JSObject *obj, int id, jsval *vp);
