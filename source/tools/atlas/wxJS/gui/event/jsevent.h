 ...
 * USA.
 *
 * $Id: jsevent.h 598 2007-03-07 20:13:28Z fbraem $
 */
/////////////////////////////////////////////////////////////////////////////
// Name:        jsevent.h
// Purpose:     Each JavaScript event object must derive from JSEvent.
//              The template argument is the class of the event.
//              This class stores a reference to the event. A JavaScript
//              event object is only valid within the function that is triggered.
//              Don't forget that the event argument of the constructor must be a reference !!! 
// Author:      Franky Braem
// Modified by:
// Created:     04.06.02
    ...
    namespace gui
    {
        ...
        public:
                             ...
                             , const char *property)
            {
		        ...
		        jsval fval;
		        if ( GetFunctionProperty(cx, obj->GetObject(), property, &fval) == JS_TRUE )
	            {
		            jsval rval;
