 ...
 * USA.
 *
 * $Id: statbar.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// wxJSStatusBar.cpp
...
StatusBar::StatusBar(JSContext *cx, JSObject *obj)
    : wxStatusBar()
    , Object(obj, cx)
{
...
bool StatusBar::GetProperty(wxStatusBar *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
    switch (id)
    {
    case P_FIELDS_COUNT:
...
bool StatusBar::SetProperty(wxStatusBar *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
    switch (id)
    {
    case P_FIELDS_COUNT:
 ...
 * </ctor>
 */
wxStatusBar* StatusBar::Construct(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, bool constructing)
{
    if ( argc > 3 )
        argc = 3;
    ...
    default:
	    ...
	    wxStatusBar *p = new StatusBar(cx, obj);
	    p->Create(parent, id, style);
...
void StatusBar::Destruct(JSContext *cx, wxStatusBar* p)
{
}
 ...
 *   bounding rectangle into the <i>Rect</i> object. Returns false on failure, true on success.
 *   <i>Rect</i> is only changed on success.
 *  </desc>
 * </method>
 */
JSBool StatusBar::getFieldRect(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
 ...
 * </method>
 */
JSBool StatusBar::getStatusText(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxStatusBar *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool StatusBar::setFieldsCount(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxStatusBar *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool StatusBar::setStatusText(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxStatusBar *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
