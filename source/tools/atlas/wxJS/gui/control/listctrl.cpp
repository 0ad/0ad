 ...
 * USA.
 *
 * $Id: listctrl.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// ListCtrl.cpp
#include <wx/wxprec.h>
#ifndef WX_PRECOMP
...
ListCtrl::ListCtrl(JSContext *cx, JSObject *obj)
    : wxListCtrl()
    , Object(obj, cx)
{
...
void ListCtrl::InitClass(JSContext *cx, JSObject *obj, JSObject *proto)
{
...
wxString ListCtrl::OnGetItemText(long item, long column) const
{
    ...
    jsval fval;
	if ( GetFunctionProperty(cx, GetObject(), "onGetItemText", &fval) == JS_FALSE )
		return wxEmptyString;
...
int ListCtrl::OnGetItemImage(long item) const
{
    ...
    jsval fval;
	if ( GetFunctionProperty(cx, GetObject(), "onGetItemImage", &fval) == JS_FALSE )
        return -1;

    jsval rval;
    jsval argv[] = { ToJS(cx, item) };
    if ( JS_CallFunctionValue(cx, GetObject(), fval, 1, argv, &rval) == JS_TRUE )
    {
        int img; 
...
bool ListCtrl::GetProperty(wxListCtrl *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
    switch (id)
    {
    case P_COLUMN_COUNT:
...
bool ListCtrl::SetProperty(wxListCtrl *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
    switch (id)
    {
    case P_ITEM_COUNT:
 ...
 * </ctor>
 */
wxListCtrl* ListCtrl::Construct(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, bool constructing)
{
    if ( argc > 6 )
        argc = 6;
    ...
    default:
	    ...
	    wxListCtrl *p = new ListCtrl(cx, obj);
...
void ListCtrl::Destruct(JSContext *cx, wxListCtrl* p)
{
}
 ...
 * </method>
 */
JSBool ListCtrl::getColumn(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
 ...
 * </method>
 */
JSBool ListCtrl::setColumn(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getColumnWidth(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setColumnWidth(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItem(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItemState(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setItemState(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setItemImage(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItemText(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setItemText(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItemData(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setItemData(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItemRect(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItemPosition(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setItemPosition(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getItemSpacing(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::setSingleStyle(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::getImageList(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
    ...
    {
        Object *imgList = dynamic_cast<Object *>(p->GetImageList(which));
        *rval = OBJECT_TO_JSVAL(imgList->GetObject());
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::setImageList(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;

    wxImageList *img = ImageList::GetPrivate(cx, argv[1]);
    int which;
    if ( FromJS(cx, argv[1], which) )
    {
        p->SetImageList(img, which);
        return JS_TRUE;
    }
 ...
 * </method>
 */
JSBool ListCtrl::refreshItem(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::refreshItems(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::deleteItem(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::deleteAllItems(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::deleteColumn(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::deleteAllColumns(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::clearAll(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::editLabel(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::endEditLabel(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::ensureVisible(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::hitTest(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::scrollList(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ListCtrl::sortItems(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxListCtrl *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
...
BEGIN_EVENT_TABLE(ListCtrl, wxListCtrl)
    EVT_LIST_BEGIN_DRAG(-1, ListCtrl::OnBeginDrag)
    EVT_LIST_BEGIN_RDRAG(-1, ListCtrl::OnBeginRDrag)
    EVT_LIST_BEGIN_LABEL_EDIT(-1, ListCtrl::OnBeginLabelEdit)
    EVT_LIST_END_LABEL_EDIT(-1, ListCtrl::OnEndLabelEdit)
    EVT_LIST_DELETE_ITEM(-1, ListCtrl::onDeleteItem)
    EVT_LIST_DELETE_ALL_ITEMS(-1, ListCtrl::onDeleteAllItems)
    EVT_LIST_ITEM_SELECTED(-1, ListCtrl::onItemSelected)
    EVT_LIST_ITEM_DESELECTED(-1, ListCtrl::onItemDeselected)
    EVT_LIST_ITEM_ACTIVATED(-1, ListCtrl::onItemActivated)
    EVT_LIST_ITEM_FOCUSED(-1, ListCtrl::onItemFocused)
    EVT_LIST_ITEM_RIGHT_CLICK(-1, ListCtrl::onItemRightClick)
    EVT_LIST_KEY_DOWN(-1, ListCtrl::onListKeyDown)
    EVT_LIST_INSERT_ITEM(-1, ListCtrl::onInsertItem)
    EVT_LIST_COL_CLICK(-1, ListCtrl::onColClick)
    EVT_LIST_COL_RIGHT_CLICK(-1, ListCtrl::onColRightClick)
    EVT_LIST_COL_BEGIN_DRAG(-1, ListCtrl::onColBeginDrag)
    EVT_LIST_COL_DRAGGING(-1, ListCtrl::onColDragging)
    EVT_LIST_COL_END_DRAG(-1, ListCtrl::onColEndDrag)
    EVT_LIST_CACHE_HINT(-1, ListCtrl::onCacheHint)
END_EVENT_TABLE()

void ListCtrl::OnBeginDrag(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onBeginDrag");
}

void ListCtrl::OnBeginRDrag(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onBeginRDrag");
}

void ListCtrl::OnBeginLabelEdit(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onBeginLabelEdit");
}

void ListCtrl::OnEndLabelEdit(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onEndLabelEdit");
}

void ListCtrl::onDeleteItem(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onDeleteItem");
}

void ListCtrl::onDeleteAllItems(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onDeleteAllItems");
}

void ListCtrl::onItemSelected(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onItemSelected");
}

void ListCtrl::onItemDeselected(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onItemDeselected");
}

void ListCtrl::onItemActivated(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onItemActivated");
}

void ListCtrl::onItemFocused(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onItemFocused");
}

void ListCtrl::onItemRightClick(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onItemRightClick");
}

void ListCtrl::onListKeyDown(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onListKeyDown");
}

void ListCtrl::onInsertItem(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onInsertItem");
}

void ListCtrl::onColClick(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onColClick");
}

void ListCtrl::onColRightClick(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onColRightClick");
}

void ListCtrl::onColBeginDrag(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onColBeginDrag");
}

void ListCtrl::onColDragging(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onColDragging");
}

void ListCtrl::onColEndDrag(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onColEndDrag");
}

void ListCtrl::onCacheHint(wxListEvent &event)
{
	PrivListEvent::Fire<ListEvent>(this, event, "onCacheHint");
}
