 ...
 * USA.
 *
 * $Id: toplevel.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// toplevel.cpp
...
bool TopLevelWindow::GetProperty(wxTopLevelWindow *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
	switch(id)  
	{
	case P_ICON:
	...
	case P_TITLE:
		*vp = ToJS(cx, p->GetTitle());
		break;
    case P_DEFAULT_ITEM:
        Object *win = dynamic_cast<Object *>(p->GetDefaultItem());
        *vp = OBJECT_TO_JSVAL(win->GetObject());
        break;
	}
...
bool TopLevelWindow::SetProperty(wxTopLevelWindow *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
	switch(id) 
	{
	case P_ICONS:
...
JSBool TopLevelWindow::requestUserAttention(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
	//TODO
	return JS_TRUE;
}

JSBool TopLevelWindow::setLeftMenu(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
	//TODO
	return JS_TRUE;
}

JSBool TopLevelWindow::setRightMenu(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
	//TODO
	return JS_TRUE;
}
 ...
 * </method>
 */
JSBool TopLevelWindow::showFullScreen(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
