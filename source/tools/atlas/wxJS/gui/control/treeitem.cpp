 ...
 * USA.
 *
 * $Id: treeitem.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// wxJSTreeItem.cpp
 ...
 *  tree items.
 *  See @wxTreeCtrl and @wxTreeItemId
 * </class>
 */
...
bool TreeItem::GetProperty(wxTreeItemId *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
...
bool TreeItem::SetProperty(wxTreeItemId *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
    JSObject *objParent = JS_GetParent(cx, obj);
    wxTreeCtrl *tree = TreeCtrl::GetPrivate(cx, objParent);
    if ( tree == NULL )
