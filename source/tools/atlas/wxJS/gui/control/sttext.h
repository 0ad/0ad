...
namespace wxjs
{
    namespace gui
    {
        ...
        public:
          ...
          static bool AddProperty(wxStaticText *p, 
                                  JSContext *cx, 
                                  JSObject *obj, 
                                  const wxString &prop, 
                                  jsval *vp);
          static bool DeleteProperty(wxStaticText *p, 
                                     JSContext* cx, 
                                     JSObject* obj, 
                                     const wxString &prop);
	        static bool GetProperty(wxStaticText *p,
                                    JSContext *cx,
                                    JSObject *obj,
                                    int id,
                                    jsval *vp);
	        static bool SetProperty(wxStaticText *p,
                                    JSContext *cx,
                                    JSObject *obj,
                                    int id,
                                    jsval *vp);

	        static wxStaticText* Construct(JSContext *cx,
                                           JSObject *obj,
                                           uintN argc,
                                           jsval *argv,
                                           bool constructing);
