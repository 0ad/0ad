 ...
 * USA.
 *
 * $Id: imagelst.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// imagelst.cpp
...
ImageList::ImageList(JSContext *cx, JSObject *obj) : wxImageList()
                                            , Object(obj, cx)
{
}
...
bool ImageList::GetProperty(wxImageList *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
    if ( id == P_IMAGE_COUNT )
 ...
 * </ctor>
 */
wxImageList* ImageList::Construct(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, bool constructing)
{
    if ( argc == 0 )
        return new ImageList(cx, obj);
    ...
    default:
        ...
        {
            ImageList *p = new ImageList(cx, obj);
 ...
 * </method>
 */
JSBool ImageList::create(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
 ...
 * </method>
 */
JSBool ImageList::add(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxImageList *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
...
JSBool ImageList::draw(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxImageList *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ImageList::getSize(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxImageList *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ImageList::remove(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxImageList *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
 ...
 * </method>
 */
JSBool ImageList::removeAll(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, jsval *rval)
{
    wxImageList *p = GetPrivate(cx, obj);
    if ( p == NULL )
        return JS_FALSE;
