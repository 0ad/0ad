 ...
 * USA.
 *
 * $Id: boxsizer.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// boxsizer.cpp
#ifndef WX_PRECOMP
	#include <wx/wx.h>
...
BoxSizer::BoxSizer(  JSContext *cx
						   , JSObject *obj
						   , int orient)
		:  wxBoxSizer(orient)
		,  Object(obj, cx)
...
void BoxSizer::Destruct(JSContext *cx, BoxSizer *p)
{
 ...
 * </ctor>
 */
BoxSizer *BoxSizer::Construct(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, bool constructing)
{
	int orient = wxVERTICAL;

	if ( FromJS(cx, argv[0], orient) )
		return new BoxSizer(cx, obj, orient);
