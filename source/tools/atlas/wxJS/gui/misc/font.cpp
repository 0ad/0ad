 ...
 * USA.
 *
 * $Id: font.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
// font.cpp
...
bool Font::SetProperty(wxFont *p, JSContext *cx, JSObject *obj, int id, jsval *vp)
{
	...
	// When there's a parent, we force the parent
	// to update the font property!
	JSObject *parent = JS_GetParent(cx, obj);
	if ( parent != NULL )
	{
        jsval prop = OBJECT_TO_JSVAL(obj);
		JS_SetProperty(cx, parent, "font", &prop);
	}
