 ...
 * USA.
 *
 * $Id: bistream.cpp 598 2007-03-07 20:13:28Z fbraem $
 */
#include <wx/wxprec.h>
#ifndef WX_PRECOMP
    #include <wx/wx.h>
 ...
 * </class>
 */
BufferedInputStream::BufferedInputStream(JSContext *cx 
					    				 , JSObject *obj
                                         , wxInputStream &s
...
Stream* BufferedInputStream::Construct(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, bool constructing)
{
    ...
    BufferedInputStream *stream = new BufferedInputStream(cx, obj, *((wxInputStream*) in->GetStream()), buffer);
