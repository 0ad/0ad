 ...
 * USA.
 *
 * $Id: dirtrav.h 598 2007-03-07 20:13:28Z fbraem $
 */
...
namespace wxjs
{
    namespace io
    {
        ...
        public:
            ...
            DirTraverser(JSContext *cx, JSObject *obj);
             ...
             */
            static DirTraverser* Construct(JSContext *cx, JSObject *obj, uintN argc, jsval *argv, bool constructing);
        };
    }; // namespace io
}; // namespace wxjs
