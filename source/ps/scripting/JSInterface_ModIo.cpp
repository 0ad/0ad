...
void JSI_ModIo::StartGetGameId(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	if (!g_ModIo)
		g_ModIo = new ModIo();
...
void JSI_ModIo::StartListMods(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	if (!g_ModIo)
	{
...
void JSI_ModIo::StartDownloadMod(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), uint32_t idx)
{
	if (!g_ModIo)
	{
...
bool JSI_ModIo::AdvanceRequest(ScriptInterface::RealmPrivate* pRealmPrivate)
{
	if (!g_ModIo)
	{
...
void JSI_ModIo::CancelRequest(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	if (!g_ModIo)
	{
...
JS::Value JSI_ModIo::GetMods(ScriptInterface::RealmPrivate* pRealmPrivate)
{
	if (!g_ModIo)
	{
...
JS::Value JSI_ModIo::GetDownloadProgress(ScriptInterface::RealmPrivate* pRealmPrivate)
{
	if (!g_ModIo)
	{
