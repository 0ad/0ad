 ...
 */
double JSI_Debug::GetMicroseconds(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return JS_Now();
}
...
int JSI_Debug::Crash(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	debug_printf("Crashing at user's request.\n");
	return *(volatile int*)0;
}

void JSI_Debug::DebugWarn(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	debug_warn(L"Warning at user's request.");
}

void JSI_Debug::DisplayErrorDialog(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& msg)
{
...
std::wstring JSI_Debug::GetBuildDate(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
...
double JSI_Debug::GetBuildTimestamp(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
...
std::wstring JSI_Debug::GetBuildRevision(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
