 ...
 */
JS::Value GetReplayAttributes(ScriptInterface::RealmPrivate* pRealmPrivate, const OsPath& directoryName);
 ...
 */
JS::Value GetReplayMetadata(ScriptInterface::RealmPrivate* pRealmPrivate, const OsPath& directoryName);
