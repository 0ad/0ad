...
namespace JSI_L10n
{
	 ...
	 *
	 * @param pRealmPrivate   JavaScript context.
	 ...
	 */
	std::wstring Translate(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& sourceString);
	 ...
	 */
	std::wstring TranslateWithContext(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& context, const std::wstring& sourceString);
	 ...
	 */
	std::wstring TranslatePlural(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& singularSourceString, const std::wstring& pluralSourceString, int number);
	 ...
	 *         translation available.
	 */
	std::wstring TranslatePluralWithContext(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& context, const std::wstring& singularSourceString, const std::wstring& pluralSourceString, int number);
	 ...
	 */
	std::wstring TranslateLines(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& sourceString);
	 ...
	 */
	std::vector<std::wstring> TranslateArray(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::vector<std::wstring>& sourceArray);
	 ...
	 */
	std::wstring FormatMillisecondsIntoDateStringLocal(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), UDate milliseconds, const std::wstring& formatString);
	...
	* @sa https://sites.google.com/site/icuprojectuserguide/formatparse/datetime?pli=1#TOC-Date-Field-Symbol-Table
	*/
	std::wstring FormatMillisecondsIntoDateStringGMT(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), UDate milliseconds, const std::wstring& formatString);
	 ...
	 */
	std::wstring FormatDecimalNumberIntoString(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), double number);
	 ...
	 */
	std::vector<std::string> GetSupportedLocaleBaseNames(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate));
	 ...
	 * @sa http://trac.wildfiregames.com/wiki/Implementation_of_Internationalization_and_Localization#LongStringsLocale
	 */
	std::vector<std::wstring> GetSupportedLocaleDisplayNames(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate));
	 ...
	 */
	std::string GetCurrentLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate));
	 ...
	 */
	std::vector<std::string> GetAllLocales(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate));
	 ...
	 * @sa http://trac.wildfiregames.com/wiki/Implementation_of_Internationalization_and_Localization#LongStringsLocale
	 */
	std::string GetDictionaryLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& configLocale);
	 ...
	 */
	std::vector<std::wstring> GetDictionariesForLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 */
	std::string GetLocaleLanguage(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 */
	std::string GetLocaleBaseName(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 */
	std::string GetLocaleCountry(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 */
	std::string GetLocaleScript(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);


	std::wstring GetFallbackToAvailableDictLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 */
	bool UseLongStrings(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate));
	 ...
	 *         or not (@c false).
	 */
	bool ValidateLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 *         (@c false).
	 */
	bool SaveLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale);
	 ...
	 * @sa GetCurrentLocale()
	 */
	void ReevaluateCurrentLocaleAndReload(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate));
}
