...
std::wstring JSI_L10n::Translate(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& sourceString)
{
...
std::wstring JSI_L10n::TranslateWithContext(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& context, const std::wstring& sourceString)
{
...
std::wstring JSI_L10n::TranslatePlural(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& singularSourceString, const std::wstring& pluralSourceString, int number)
{
...
std::wstring JSI_L10n::TranslatePluralWithContext(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& context, const std::wstring& singularSourceString, const std::wstring& pluralSourceString, int number)
{
...
std::wstring JSI_L10n::TranslateLines(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::wstring& sourceString)
{
...
std::vector<std::wstring> JSI_L10n::TranslateArray(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::vector<std::wstring>& sourceArray)
{
...
std::wstring JSI_L10n::GetFallbackToAvailableDictLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.GetFallbackToAvailableDictLocale(locale);
}

// Return a localized version of a time given in milliseconds.
std::wstring JSI_L10n::FormatMillisecondsIntoDateStringLocal(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), UDate milliseconds, const std::wstring& formatString)
{
...
std::wstring JSI_L10n::FormatMillisecondsIntoDateStringGMT(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), UDate milliseconds, const std::wstring& formatString)
{
...
std::wstring JSI_L10n::FormatDecimalNumberIntoString(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), double number)
{
	return wstring_from_utf8(g_L10n.FormatDecimalNumberIntoString(number));
}

std::vector<std::string> JSI_L10n::GetSupportedLocaleBaseNames(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return g_L10n.GetSupportedLocaleBaseNames();
}

std::vector<std::wstring> JSI_L10n::GetSupportedLocaleDisplayNames(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return g_L10n.GetSupportedLocaleDisplayNames();
}

std::string JSI_L10n::GetCurrentLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return g_L10n.GetCurrentLocaleString();
}

bool JSI_L10n::UseLongStrings(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return g_L10n.UseLongStrings();
}

std::vector<std::string> JSI_L10n::GetAllLocales(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
	return g_L10n.GetAllLocales();
}

std::string JSI_L10n::GetDictionaryLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& configLocale)
{
	return g_L10n.GetDictionaryLocale(configLocale);
}

std::vector<std::wstring> JSI_L10n::GetDictionariesForLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.GetDictionariesForLocale(locale);
}

std::string JSI_L10n::GetLocaleLanguage(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.GetLocaleLanguage(locale);
}

std::string JSI_L10n::GetLocaleBaseName(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.GetLocaleBaseName(locale);
}

std::string JSI_L10n::GetLocaleCountry(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.GetLocaleCountry(locale);
}

std::string JSI_L10n::GetLocaleScript(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.GetLocaleScript(locale);
}

bool JSI_L10n::ValidateLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.ValidateLocale(locale);
}

bool JSI_L10n::SaveLocale(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate), const std::string& locale)
{
	return g_L10n.SaveLocale(locale);
}

void JSI_L10n::ReevaluateCurrentLocaleAndReload(ScriptInterface::RealmPrivate* UNUSED(pRealmPrivate))
{
